            ...
            <form action="{{ route('product.create.submit') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="storange_capcity" name="storange_capcity"
                        value="{{ old('storange_capcity') }}" class="form-control">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="display_size" name="display_size" value="{{ old('display_size') }}"
                        class="form-control">
                    @error('display_size')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="graphic_card" name="graphic_card" value="{{ old('graphic_card') }}"
                        class="form-control">
                    @error('graphic_card')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="warranty_period" name="warranty_period"
                        value="{{ old('warranty_period') }}" class="form-control">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" id="image" name="image" value="{{ old('image') }}" class="form-image">
                    @error('image')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
